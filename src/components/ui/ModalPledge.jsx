...
const ModalPledge = ({
  ...
  return (
    <div id={`modal-pledge-${id}`} className={wrapperClasses}>
      <div className={classes['mobile-pledge']}>
      ...
      <div className={classes['desktop-pledge']}>
        <div className={classes['pledge-inner']}>
          <div className={classes['checkbox-wrapper']}>
            <Checkbox
              onClick={disableCheckbox ? () => {} : () => selectPledge(id)}
              ...
              disabled={disableCheckbox}
            />
            <div className={classes['title-pledges-left-wrapper']}>
              <div className={classes['title-minimum-pledge-wrapper']}>
                <p className={classes.title}>{title}</p>
                {showMinimumPledge && (
                  <p className={classes['minimum-pledge']}>
                    Pledge ${minimumPledge} or more
